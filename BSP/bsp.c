...
void  BSP_Init (void)
{
    ...
    RCC_OTGFSCLKConfig(RCC_OTGFSCLKSource_PLLVCO_Div3);        /* OTGCLK  = PLL1VCO / USBPRES(3)  = 144MHz / 3 = 48MHz */
...
*
* Arguments  :  file          File name as string.
*
*               line          Line in file where the error occurred.
*
*               p_err         A pointer to an error code.
*
* Returns    :  none
*********************************************************************************************************
*/
